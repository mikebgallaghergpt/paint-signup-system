      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {currentStep === 0 && (
          <div className="space-y-4 animate-fadeIn">
            ...
            <Button type="button" onClick={nextStep} className="w-full" size="lg">Continue →</Button>
          </div>
        )}
        ...
        {currentStep === 2 && (
          <div className="space-y-4 animate-fadeIn">
            ...
            <div className="flex gap-2">
              <Button type="button" onClick={prevStep} variant="outline" className="flex-1">← Back</Button>
              <Button type="submit" disabled={submitting} className="flex-1" size="lg">{submitting ? "Creating..." : "Create Account 🎉"}</Button>
            </div>
            <div className="text-center text-xs text-gray-500">🔒 Your information is secure and will never be shared</div>
          </div>
        )}
      </form>
    </div>
